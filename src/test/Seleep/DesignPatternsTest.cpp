#include "DesignPatternsTest.hpp"
...
void DesignPatternsTest::onRun() {
  ...
  runner.run(
      [this, &runner] {
        ...
        auto response = client->getDesignPatternsMC();
        ...
        response = client->getDesignPatternsTF();
        ...
        response = client->getDesignPatternsMATCH();
        qResponse = response->readBodyToDto<oatpp::Object<QuestionDTO>>(
            objectMapper.get());
        OATPP_ASSERT(response->getStatusCode() == 200);
        OATPP_ASSERT(qResponse->question != "");
        ...
        response = client->getDesignPatternsFILL();
        qResponse = response->readBodyToDto<oatpp::Object<QuestionDTO>>(
            objectMapper.get());
        OATPP_ASSERT(response->getStatusCode() == 200);
        OATPP_ASSERT(qResponse->question != "");
        ...
        response = client->postAnswer(
            "{\"id\": 1, \"type\": \"MATCH\", \"topic\": \"DesignPatterns\", "
            "\"answer\": [\"Key1\", \"Key\"]}");
        OATPP_ASSERT(response->getStatusCode() == 200);
        ...
        std::cout << message->answer << std::endl;
        OATPP_ASSERT(message->answer == true);

        // Good answer - TF
        response = client->postAnswer(
            "{\"id\": 1, \"type\": \"TF\", \"topic\": \"DesignPatterns\", "
            "\"answer\": [\"True\"]}");
        OATPP_ASSERT(response->getStatusCode() == 200);
        /* Read response body as MessageDto */
        ...
        // Good answer - FILL
        response = client->postAnswer(
            "{\"id\": 1, \"type\": \"FILL\", \"topic\": \"DesignPatterns\", "
            "\"answer\": [\"Builder\"]}");
        OATPP_ASSERT(response->getStatusCode() == 200);
        /* Read response body as MessageDto */
        message = response->readBodyToDto<oatpp::Object<AnswerDTO>>(
        ...
        // Good answer - MC
        response = client->postAnswer(
            "{\"id\": 0, \"type\": \"MC\", \"topic\": \"DesignPatterns\", "
            "\"answer\": [\"test\"]}");
        OATPP_ASSERT(response->getStatusCode() == 200);
        /* Read response body as MessageDto */
        message = response->readBodyToDto<oatpp::Object<AnswerDTO>>(
        ...
        // BAD ID input - Any
        response = client->postAnswer(
            "{\"id\": 100, \"type\": \"MC\", \"topic\": \"DesignPatterns\", "
            "\"answer\": [\"TEST\"]}");
