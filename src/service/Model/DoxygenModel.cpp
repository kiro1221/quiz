...
void DoxygenModel::readInQuestions() {
    std::string filename = "src/service/Data/DoxygenData.txt";
    ...
    while (std::getline(file, typeAndText)) {
        ...
        std::string topicName = "Doxygen", questionType = "", questionText = "";
